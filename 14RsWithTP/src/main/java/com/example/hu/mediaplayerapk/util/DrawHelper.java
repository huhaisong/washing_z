...
public class DrawHelper {
    private static String TAG = "DrawHelper";
    ...
    public DrawHelper(int previewWidth, int previewHeight, int canvasWidth,
        ...
        Log.d(TAG, "cameraW,cameraH,canvasW,canvasH" + previewWidth+" "+previewHeight+" "+canvasWidth+" "+canvasHeight);
    ...
    public static void drawFaceRect(Canvas canvas, DrawInfo drawInfo, int color, int faceRectThickness) {
        ...
        if (drawInfo.getName() == null) {
            ...
            String str = (drawInfo.getSex() == Config.MALE ? "MALE" : (drawInfo.getSex() == Config.FEMALE ? "FEMALE" : "UNKNOWN"))
                    + ","
                    + (drawInfo.getAge() == Config.UNKNOWN_AGE ? "UNKNWON" : drawInfo.getAge())
                    + ","
                    + (drawInfo.getLiveness() == Config.ALIVE ? "ALIVE" : (drawInfo.getLiveness() == Config.NOT_ALIVE ? "NOT_ALIVE" : "UNKNOWN"));
