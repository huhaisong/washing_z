 ...
 */
package com.example.hu.mediaplayerapk.util.runtimepermissions;
...
public class PermissionsManager {
   ...
   * @param action      the action to subtract to the current list of pending actions.
   */
   ...
   * they need to be requested (i.e. we don't have permission yet) and will subtract the
   ...
   * If a permission is not granted, subtract it to the result list
   * if a permission is granted, do the granted work, do not subtract it to the result list
   *
   * @param activity    the activity to check permissions
